...
" The dark.vim theme:
let s:airline_a_normal   = [ '#c6c6c6' , '#005fff' , 251  , 27 ]
let s:airline_b_normal   = [ '238' , '#444444' , 'Gray' , 238 ]
let s:airline_c_normal   = [ '' , '#303030' , ''  , 236 ]
let g:airline#themes#blues#palette.normal = airline#themes#generate_color_map(s:airline_a_normal, s:airline_b_normal, s:airline_c_normal)

" It should be noted the above is equivalent to:
" let g:airline#themes#blues#palette.normal = airline#themes#generate_color_map(
...
" let g:airline#themes#blues#palette.normal = {
...
" applied after g:airline#themes#blues#palette.normal, hence why only certain keys are
" declared.
let g:airline#themes#blues#palette.normal_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 53      , ''     ] ,
      \ }


let s:airline_a_insert = [ '#ffffff' , '#0087d7' , 255 , 32  ]
let s:airline_b_insert = [ '#ffffff' , '#00afd7' , 255 , 38  ]
let s:airline_c_insert = [ '#ffffff' , '#1c1c1c' , 15  , 234 ]
let g:airline#themes#blues#palette.insert = airline#themes#generate_color_map(s:airline_a_insert, s:airline_b_insert, s:airline_c_insert)
let g:airline#themes#blues#palette.insert_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 53      , ''     ] ,
      \ }
let g:airline#themes#blues#palette.insert_paste = {
      \ 'airline_a': [ s:airline_a_insert[0]   , '#d78700' , s:airline_a_insert[2] , 172     , ''     ] ,
      \ }


let g:airline#themes#blues#palette.replace = copy(g:airline#themes#blues#palette.insert)
let g:airline#themes#blues#palette.replace.airline_a = [ s:airline_b_insert[0]   , '#af0000' , s:airline_b_insert[2] , 124     , ''     ]
let g:airline#themes#blues#palette.replace_modified = g:airline#themes#blues#palette.insert_modified
...
let g:airline#themes#blues#palette.visual = airline#themes#generate_color_map(s:airline_a_visual, s:airline_b_visual, s:airline_c_visual)
let g:airline#themes#blues#palette.visual_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 53      , ''     ] ,
      \ }
...
let g:airline#themes#blues#palette.inactive = airline#themes#generate_color_map(s:airline_a_inactive, s:airline_b_inactive, s:airline_c_inactive)
let g:airline#themes#blues#palette.inactive_modified = {
      \ 'airline_c': [ '#875faf' , '' , 97 , '' , '' ] ,
      \ }
...
let g:airline#themes#blues#palette.accents = {
      \ 'red': [ '#ff0000' , '' , 160 , ''  ]
      \ }
...
if get(g:, 'loaded_ctrlp', 0)
  let g:airline#themes#blues#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
